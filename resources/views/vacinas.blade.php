<x-app-layout>
    <div class="container mx-auto p-8">
        <h1 class="text-3xl font-bold mb-4">Vacinas dos Animais</h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 my-6">
            ...
            <div class="flex justify-end mt-4">
                <a href="{{ route('vacina.download', ['id' => $animal->id]) }}" class="bg-[#7d77fe] hover:bg-[#918bff] text-white font-bold py-2 px-4 rounded">
                    Baixar Informações
                </a>
            </div>
        </div>
